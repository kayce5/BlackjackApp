...
public class GameFragment extends Fragment {
   private TextView playerName, scoreLbl, dealerScoreLbl;
   private Button btnStart, btnHit, btnStay;
   ...
   private ImageView[] playerArray = new ImageView[5];
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        String name = pref.getString("playerName", null);
    ...
    private void endGame(){
        ...
        dealer3.setVisibility(View.INVISIBLE);
        dealer4.setVisibility(View.INVISIBLE);
        dealer5.setVisibility(View.INVISIBLE);
        ...
        dealerScoreLbl.setVisibility(View.INVISIBLE);
    }
